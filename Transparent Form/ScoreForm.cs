...
namespace Transparent_Form
{
    public partial class ScoreForm : Form
    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không có dữ liệu nào !", "Field Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                ...
                if (!score.checkScore(stdId, cName))
                {
                    ...
                    if (score.insertScore(stdId, cName, scor, desc))
                    {
                        ...
                        MessageBox.Show("Đã thêm bảng điểm mới!", "Thêm bảng điểm", MessageBoxButtons.OK, MessageBoxIcon.Information);

                    }
                    else
                    {
                        MessageBox.Show("Bảng điểm chưa tồn tại trong hệ thống!", "Thêm bảng điểm", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
                    MessageBox.Show("Bảng điểm này đã tồn tại trong hệ thống!", "Thêm bảng điểm", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
